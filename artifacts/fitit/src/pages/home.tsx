    ...
    <Layout>
      ...
      <section className="py-20 lg:py-32 bg-primary/5">
        <div className="container">
          <div className="max-w-[780px] mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-[560px] mx-auto">
      ...
      <section className="py-24 bg-background">
        <div className="container">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold tracking-tight">Как работает</h2>
          </div>
            ...
            {HOW_IT_WORKS.map((item) => {
              ...
              return (
                <div key={item.step} className="relative text-center space-y-4">
                  ...
                  <div className="absolute top-0 right-0 h-8 w-8 bg-primary text-primary-foreground rounded-full text-sm font-bold flex items-center justify-center shadow">
                    {item.step}
                  </div>
      ...
      <section className="py-24 bg-muted/30">
        <div className="container">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold tracking-tight">Что входит в план</h2>
          </div>
            ...
            {WHATS_INCLUDED.map((item) => {
              ...
              return (
                <Card key={item.label} className="text-center hover:border-primary transition-colors">
                  <CardContent className="pt-6 pb-4 px-3 space-y-3">
                    <div className="mx-auto h-10 w-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {TIERS.map((tier) => (
              <Card key={tier.label} className={`relative flex flex-col text-center ${tier.highlight ? "border-primary shadow-lg ring-1 ring-primary" : ""}`}>
                ...
                <CardContent className="pt-8 pb-6 space-y-4 flex-1 flex flex-col">
                  <div>
